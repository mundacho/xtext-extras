...
entryRuleBug462047Root returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getBug462047RootRule()); }
	iv_ruleBug462047Root=ruleBug462047Root
	{ $current=$iv_ruleBug462047Root.current; }
	EOF;

// Rule Bug462047Root
ruleBug462047Root returns [EObject current=null]
:
	(
		(
			{
...
entryRuleBug462047Element returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getBug462047ElementRule()); }
	iv_ruleBug462047Element=ruleBug462047Element
	{ $current=$iv_ruleBug462047Element.current; }
	EOF;

// Rule Bug462047Element
ruleBug462047Element returns [EObject current=null]
:
	(
		otherlv_0='element'
		{
