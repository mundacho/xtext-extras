...
entryRuleImportSectionTestLanguageRoot returns [EObject current=null]:
	...
	{ $current=$iv_ruleImportSectionTestLanguageRoot.current; }
	EOF;

// Rule ImportSectionTestLanguageRoot
ruleImportSectionTestLanguageRoot returns [EObject current=null]
:
	(
		otherlv_0='some'
		{
